...
public class AimVersionPreferenceController extends PreferenceController
    ...
    public AimVersionPreferenceController(Context context, Lifecycle lifecycle) {
        super(context);
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        final Preference pref = screen.findPreference(KEY_AIM_VERSION);
        if (pref != null) {
            pref.setSummary(android.os.Build.AIM_DISPLAY_VERSION);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (!TextUtils.equals(preference.getKey(), KEY_AIM_VERSION)) {
            return false;
        }
